...
class _EditMoviePageState extends State<EditMoviePage> {
   ...
   MovieModel movie = Get.arguments['movie'];
   MovieBloc bloc = Get.arguments['bloc'];
                  ...
                  children: [
                    ...
                    _selectedImageAsset != null && _selectedImageAsset!.isNotEmpty
                      ...
                      height: 100,
                        ...
                        : Image.network(
                      '${ServiceRepository.baseURL}${movie.imageasset.toString()}',
                      width: 100,
                      height: 100,
                    ),
                  ],
                  ...
                  children: [
                    ...
                    _selectedImageBanner != null && _selectedImageBanner!.isNotEmpty
                      ...
                      height: 100,
                        ...
                        : Image.network(
                      '${ServiceRepository.baseURL}${movie.imagebanner.toString()}',
                      width: 100,
                      height: 100,
                    ),
                  ],
