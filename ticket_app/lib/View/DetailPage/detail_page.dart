...
class _MyDetailPageState extends State<MyDetailPage> {
  ...
  Widget build(BuildContext context) {
    final MovieModel? myMovie = Get.arguments;
    if (myMovie == null) {
      return Scaffold(
        appBar: AppBar(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage('${ServiceRepository.baseURL}${myMovie.imagebanner}'),
                            fit: BoxFit.cover
                        ),
                      ),
                      child: Container(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage('${ServiceRepository.baseURL}${myMovie.imageasset}'),
                            fit: BoxFit.cover
                          ),
                    ...
                    Positioned(
                       left: MediaQuery.of(context).size.width * 0.45,
                        ...
                        child: InfoMovieWidget(myMovie: myMovie,)
                    ),
                    Positioned(
                      ...
                      child: Container(
                        ...
                        //color: Colors.green,
                        child: Info2MovieWidget(myMovie: myMovie,)
                      ),
                    ...
                    Positioned(
                        ...
                        child: MyDescription(myMovie: myMovie,)
